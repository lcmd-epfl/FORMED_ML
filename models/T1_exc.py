...
X_pool = np.load("../data/repr.npy")
y_pool = np.load("../data/T1_exc.npy")
...
plt.ylabel(r"$T_{1}^{vert}$ MAE $\it{(eV)}$")
...
plt.show()
plt.savefig("xgboost_T1_exc_lc.png")
pickle.dump(model, open("T1_exc_model.sav", "wb"))
